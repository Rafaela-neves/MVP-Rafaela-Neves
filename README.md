...
- [`01_bronze_ingestao.ipynb`](01_bronze_ingestao.ipynb)
- [`02_silver_transformacao.ipynb`](02_silver_transformacao.ipynb)
- [`03_gold_modelagem.ipynb`](03_gold_modelagem.ipynb)
...
O detalhamento completo (com os resultados de cada query) está no notebook [`04_analise_qualidade.ipynb`](04_analise_qualidade.ipynb).

---

## 7️⃣ Análise e Respostas às Perguntas de Negócio

O código completo desta análise está no notebook [`05_analise_negocio.ipynb`](05_analise_negocio.ipynb).
